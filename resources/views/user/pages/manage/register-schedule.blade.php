                            ...
                            <tr class="odd gradeX" align="center">
                                ...
                                <td>
                                    @if ($schedule->session == 0)
                                        <span class="badge badge-primary" style="padding: 10px">Cả ngày</span>
                                    @elseif ($schedule->session == 1)
                                        <span class="badge badge-info" style="padding: 10px"><b>Ca sáng</b></span>
                                    @else
                                        <span class="badge badge-warning" style="padding: 10px"><b>Ca chiều</b></span>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
                                ...
                                <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-primary btn-submit">Có</button>
        ...
        $(document).ready(function (){
            ...
            $('#confirm').click(function(){
                ...
                if(thu2 == 'null' && thu3 == 'null' && thu4 == 'null' && thu5 == 'null' && thu6 == 'null'){
                    ...
                    "<li class='list-group-item'>Thứ 5: <strong>"+check(thu5)+"</strong></li>"+
                    "<li class='list-group-item'>Thứ 6: <strong>"+check(thu6)+"</strong></li>"+
                    "<li class='list-group-item'><h2>Bạn chắc chắn muốn lưu lịch này?</h2></li>"
                    +"</ul>";
                    $('.btn-close').text('Không');
                    $('.btn-submit').show();
                    $('.modal-body').html(output);
                }
            });
