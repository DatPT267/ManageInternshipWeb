...
<head>
    ...
    {{-- ================================Datatables========================== --}}
    {{-- <link rel="stylesheet" type="text/css" href="admin_asset1/css/Content/html/css/dataTables.bootstrap4.min.css"> --}}
    {{-- ================================end Datatables========================== --}}
...
<!-- end footter -->
    ...
    {{-- ===============================Datatables======================= --}}
    {{-- <script type="text/javascript" src="admin_asset1/css/Content/html/js/jquery-3.5.1.js"></script>
    <script type="text/javascript" src="admin_asset1/css/Content/html/js/jquery.dataTables.min.js"></script>
    <script type="text/javascript" src="admin_asset1/css/Content/html/js/dataTables.bootstrap4.min.js"></script> --}}
    {{-- ===============================END Datatables======================= --}}
    @yield('script')
</body>
</html>
