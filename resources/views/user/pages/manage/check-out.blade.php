        ...
        @else
            @if ($isCheckout == 1)
                ...
                <div class="form-group" style="display: flex">
                    ...
                    <input type="text" class="form-control"  value="{{\Carbon\Carbon::parse($checkout->date_end)->format('d-m-Y H:i:s')}}" style="flex: 5" disabled>
                </div>
                <div class="form-group" style="display: flex">
                ...
                <div class="form-group" style="display: flex">
                    ...
                    <label style="flex: 5">{{$checkout->note}}</label>
                </div>
