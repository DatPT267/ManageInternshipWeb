...
<hr>
<span>Nội dung review: <strong>{{$review->content}}</strong></span><br>
<span>Người viết review: <strong>{{$review->user->name}}</strong></span>
<hr>
@if (count($errors) > 0)
...
@endif
<button type="button" class="btn btn-primary" data-toggle="modal" data-target=".modal-create-feedback">Thêm feedback</button>
@include('admin.pages.manageTasks.feedbacks.add-feedback')
